...
class DataPreProcessor(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, columnas_categoricas: list = None, columnas_numericas: list = None) -> None:
        """
    ...
    def fit(self, X: pd.DataFrame, y=None):
        ...
        self.preprocesador = ColumnTransformer(transformers=[
            ('cat', OneHotEncoder( drop='if_binary',handle_unknown='ignore', sparse_output=False), self.columnas_categoricas),
